...
public class DriverController {
    ...
    public final static boolean lMenu = controller.getRawButton(5);
    public final static boolean rMenu = controller.getRawButton(6);
    public final static boolean lBumper = controller.getRawButton(7);
    public final static boolean rBumper = controller.getRawButton(8);
